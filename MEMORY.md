...
* **Cycle → icon mapping (Option A, locked 2026-06-08):** Torii (C1, 1mo), Waterfall & lily (C2, 18mo), 1-Year Koi (C3, gold tier — replaces logo in recap rotation), Stag (C4, 4mo), Kraken lighthouse (C5, 5mo), Fox in snow (C6, 9mo), Rowing POV (C7, 2yr), Resting horse (C8, 3yr), Desert landscape (C9, 2mo), Frog (C10, 3mo), Koi 6mo top seller (C11, late return), Phoenix (C12, 1yr). **Two distinct koi watercolors**: C3 = calm water, gold-palette, portrait composition; C11 = mid-leap, red-orange, landscape composition. ANA logo dropped from recap spreads — already lives on back cover + intro p1. 11 unique coin motifs = 12 designs (no logo in recap). 1-year koi now used (2026-06-08 reversal of the v2 rule).
...
* **Logo placement (revised 2026-06-08):** Back cover (small + wordmark) + intro p1 (logo + wordmark) only. Daily page footer ornament removed (sister feedback 2026-06-08 — page number only at the bottom of every daily page, no two-fish logo). Recap spreads have no logo (C3 is the 1-yr koi, not the two-fish). Nothing front cover.
