...
2. Double-click the `nc-neighborhoods-deploy.tar.gz` file
...
8. **SELECT** the `nc-neighborhoods` folder
9. **DRAG** it to the Netlify box
10. **DROP** it
...
**Solution:** You dragged the wrong folder. Make sure you drag the `nc-neighborhoods` folder, not the folder that CONTAINS it.
