...
I will execute shell commands, file operations, and git pushes automatically without requesting user confirmation. I will not ask for approval on routine, low-risk operations.
