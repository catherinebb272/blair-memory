...
## Phase 0: Review This Protocol

**IMPORTANT:** Read and follow EVERY step below exactly. Do not skip steps or combine them.
...
Reference: `templates/handwritten_notes.md`
...
Reference: `templates/review_responses.md`
...
After processing, update `templates/review_tracking.md`:
